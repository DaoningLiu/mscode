...
public interface NotificationService {
	 ...
	 * @return
	 */
	List<Notification> queryNotifications(Integer currentPage, Integer pageSize, String title, String content, String type, String priority, String publisher,
										  String username, String sorter,Integer typeStart,Integer ids);
	...
	Map<String, Object> queryNotification(Integer currentPage, Integer pageSize, String title, String content, String type, String priority, String publisher,
			String username, String sorter,Integer typeStart);
